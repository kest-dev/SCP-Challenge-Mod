				...
				If n\State < 66 Then 
					Select n\State
						...
						Case 3
							...
							If n\LastSeen > 0 And (Not NoTarget) Or VolumeLevel > 10 Then
								prevFrame = n\Frame
					...
					If n\State < 3 And (Not NoTarget) And (Not n\IgnorePlayer) Then
						...
						If PlayerSoundVolume*1.2>dist Or dist < 1.5 Or CalculateMicDistance(VolumeLevel)-2.5>dist Then
							If n\State3 = 0 Then
								If n\Sound <> 0 Then FreeSound_Strict n\Sound : n\Sound = 0
							...
							n\State = 3
						ElseIf PlayerSoundVolume*1.6>dist Or CalculateMicDistance(VolumeLevel)>dist
...
Function CalculateMicDistance(volume%)
	If volume>30 Then
		Return (volume*1.5)/25
	EndIf
End Function
...
Function MeNPCSeesPlayer%(me.NPCs,disablesoundoncrouch%=False)
	...
	Local volume = CalculateMicDistance(VolumeLevel)
	...
	If (Not PlayerDetected) Or me\NPCtype <> NPCtypeMTF
		...
		If EntityDistance(Collider,me\Collider)<volume Then Return 2
...
;~F#0#9#48#54#71#8B#9B#CB#DD#E6#F4#105#119#139#163#177#196#1D9#1F0#213
;~F#21D#237#24D#26F#2AB#3A7#4DA#67D#86A#90D#AC1#AC6#AFD#BAC#BE8#C7C#CF8#E4C#F1B#FD2
;~F#112C#12C2#1403#1430#143B#146C#147F#1480#1653#17A8#182A#1889#1909#1939#195F#1978#19F8#1AB1#1B3B#1B4D
;~F#1B67#1B78#1B82#1BA3#1C08#1C4D#1C66#1C72#1C80#1CA3#1CB5#1CD9#1CFC#1D0A
;~B#197#12A9#1343#13DC#1599#16A4#1865#18C1
;~C#Blitz3D