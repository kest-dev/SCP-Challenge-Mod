...
Global EnableMic% = GetINIInt(OptionFile, "challenge", "mic")
Global EnableZombie% = GetINIInt(OptionFile, "challenge", "zombies")
Global ZombieChance% = GetINIInt(OptionFile, "challenge", "zombie_chance")
...
Function InitEvents()
	...
	If EnableZombie Then
		CreateEvent("spawn_zombie","endroom",0,ZombieChance)
		CreateEvent("spawn_zombie","room2_2",0,ZombieChance)
		CreateEvent("spawn_zombie","room2_3",0,ZombieChance)
		CreateEvent("spawn_zombie","room2_4",0,ZombieChance)
		CreateEvent("spawn_zombie","room3_2",0,ZombieChance)
	EndIf
...
Repeat
	...
	Else
		...
		If (Not MenuOpen) And (Not InvOpen) And (OtherOpen=Null) And (SelectedDoor = Null) And (ConsoleOpen = False) And (Using294 = False) And (SelectedScreen = Null) And EndingTimer=>0 Then
			If EnableMic Then
				VolumeLevel = Abs(BASS_ChannelGetLevel(BassHandle)/10000000)
			EndIf
...
Function DrawGUI()
	...
	If HUDenabled Then 
		...
		If DebugHUD Then
			...
			EndIf
			AAText x + 350, 330, "Mic Volume: "+VolumeLevel+" Mic Distance: "+CalculateMicDistance(VolumeLevel)
			AASetFont Font1
		EndIf
...
;~F#44#E3#184#18A#19A#24E#2F9#302#322#336#33B#341#347#34D#353#358#376#38C#3A1#3A7
;~F#3AD#3B4#3BB#3C8#3CE#3D4#3DA#3E1#3F0#3F9#405#417#430#44C#451#45E#470#48B#492#498
;~F#4A6#4B9#4C2#4CB#4F1#503#51A#526#532#545#54B#551#555#55B#560#57F#58E#59D#5A3#5A8
;~F#5AF#5BF#61A#6BD#730#754#7F6#803#8D6#976#98D#99B#A94#AA3#ADB#AF5#AFE#BE3#D3C#D4D
;~F#D84#DAC#DBB#DE3#E0D#E26#E39#E69#E81#F34#F3D#F54#FB2#FDF#1128#121C#13BD#1547#15A0#15CF
;~F#15EA#1601#1618#162F#1646#1653#166E#1672#1676#167F#169A#16CD#1727#1732#173E#174A#1775#1784#17C3#17D0
;~F#17DD#17F2#1936#1952#1962#1972#197F#19AD#19D2#19F0#1AC4#1B20#1B36#1B42#1B59#1B64#1B71#1B7B#1B89#1BE2
;~F#1C5C#1CB6#1CF1#1D4C#1E9A#1EA6#1F68#2044#20D2#2177#21A4#21D5#22F1#2303#231F#2329#2336#235A#239A#23DA
;~F#242A#2463#2477#248C#2490#24B0#24B8#24E3#2746#2804#2863#28BB#296C#2976#297C#2986#2992#299D#29A1#29DC
;~F#29E4#29EC#29F3#29FA#2A07#2A0D#2A1A#2A29#2A47#2A75#2A7C#2A8F#2AA8#2AD5#2AE0#2AE5#2AFF#2B0B#2B26#2B78
;~F#2B86#2B8E#2B96#2BC3#2BCC#2BF5#2BFA#2BFF#2C04#2C0D#2C1E#2CC3#2CD1#2D00#2D3C#2D4E#2D6D#2D7C#2D93#2DB6
;~F#2DBA#2DBE#2DEC#2E0A#2E15#2E43#2E61#2EAA#2EC3#2ED2#2EE2#2EF2#2F2D
;~B#11F3#146B#1C09
;~C#Blitz3D