Function UpdateEvents()
	...
	Local p.Particles, n.NPCs, r.Rooms, e.Events, e2.Events, it.Items, it2.Items, em.Emitters, sc.SecurityCams, sc2.SecurityCams, w.WayPoints
...
;						EndIf
			...
			Case "spawn_zombie"				;[Block]
				For w.WayPoints = Each WayPoints
					If Rand(0,3)=1 Then
						e\room\NPC[12] = CreateNPC(NPCtypeZombie, EntityX(w\obj), EntityY(w\obj), EntityZ(w\obj))
						RemoveEvent(e)
						Exit
					EndIf
				Next
...
;~F#13#30#15A#58C#59C#608#6F2#74F#77E#78C#796#7A3#9D9#A10#A35#A7F#A8C#AC6#AD7#AF7
;~F#B0D#B17#B26#C1D#C3F#F50#F97#FAF#FBB#FD8#102E#1047#117C#127E#12FE#1317#1336#1396#13A3#13BD
;~F#145A#1611#1703#1773#183E#1907#19D2#19E5#1AB9#1AE6#1B03#1B2C#1B78#1BB0#1BD9#1C35#1C73#1CA4#1CB7#1D82
;~F#1DFD#1E10#1E27#1E48#1F36#1FAC#20F7#20FB#219C#21C5#21EE#21F6#220C#2257#23DC#2589
;~B#10D3#1DD1
;~C#Blitz3D